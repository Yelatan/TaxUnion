...
- (void)viewDidLoad
{
    ...
    NSDate *date = [NSDate dateWithDay:22 month:6 year:2016];
    ...
    NSString *integrationTitle = NSLocalizedString(@"Integrate MBCalendarKit", @" Yeletan asdad");
    NSString *integrationinfo = NSLocalizedString(@"Bakbergen Yeletan", @"Sdu forever");
    NSDate *integrationDate = date2;
    CKCalendarEvent *integrationEvent = [CKCalendarEvent eventWithTitle:integrationTitle andDate:integrationDate andInfo:integrationinfo];
    
    //  An event for the new MBCalendarKit release.
    NSString *title3 = NSLocalizedString(@"Fix bug where events don't show up immediately.", @"");
    NSDate *date3 = [NSDate dateWithDay:29 month:6 year:2017];
