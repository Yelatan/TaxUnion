...
//    
//    UIBarButtonItem *yButton = [[UIBarButtonItem alloc] initWithTitle:@"Yesterday" style:UIBarButtonItemStylePlain target:self action:@selector(pushTodayButton:)];
//    UIBarButtonItem *cModeButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemOrganize target:self action:@selector(cModeButton:)];
//    
    [self.navigationItem setRightBarButtonItems:@[todayButton, changeModeButton]];
//    [self.navigationItem setLeftBarButtonItems:@[yButton, cModeButton]];
}
