...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, CustomCellDelegate {
    ...
    var vc: GoodsforIPViewController?
    
    
    @IBOutlet weak var tblExpandable: UITableView!
    @IBOutlet weak var menuButton:UIBarButtonItem!
    @IBAction func kick(sender: AnyObject) {
...
//            let tmpArray = NSMutableArray(contentsOfFile: path)
//            
////            var mutArray : Array < [String: AnyObject] >!
////            
////            for item in tmpArray! {
////                mutArray.append(item as! [String : AnyObject]);
////            }
////            
////            cellDescriptors = tmpArray
